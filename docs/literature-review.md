...
The question of how many unidentified digests exist in the Taisho has remained open. Given the vast size of the canon (approximately 80 million Chinese characters of text) and the extensive repetition of material across Buddhist scriptural traditions, it has been plausible that many digest relationships remained to be discovered. Our pipeline's detection of 181 full digests and 484 partial digests represents the first systematic attempt to answer this question computationally.
...
- **Condensation**: The content of a longer text is summarized or paraphrased, producing a shorter text that shares content but not exact wording. These are harder for character-level comparison to detect and likely appear in our pipeline as partial digests or shared tradition relationships.
